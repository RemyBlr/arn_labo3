...
### Architecture
![Architecture](./assets/1st_experiment/model_summary.png){width=65%}
...
### Training history
![Training history](./assets/1st_experiment/3f_cv.png){width=65%}
...
### Architecture
![Architecture](./assets/2nd_experiment/2nd_model_summary.png){width=65%}
...
### Training history
![Training history](./assets/2nd_experiment/2nd_3f_cv.png){width=65%}
...
![Model summary](./assets/competition/comp_model_summary.png){width=65%}
...
![3-fold cross-validation loss](./assets/competition/comp_3f_cv.png){width=65%}
